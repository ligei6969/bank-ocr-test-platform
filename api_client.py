"""Small HTTP client used by Day 1 test-development exercises."""
...
@dataclass
class ApiResponse:
    """Normalized API response for assertions in tests."""
...
class BankOcrApiClient(ApiClient):
    """Project-specific client that keeps endpoint names in one place."""
